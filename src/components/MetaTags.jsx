...
export default function MetaTags() {
  return (
    <>
      ...
      <meta property="og:description" content={meta_data.openGraph.description} />
      <meta property="og:image" content={meta_data.openGraph.image} />
      <meta
        property="og:image:secure_url"
        content={meta_data.openGraph.imageSecureUrl}
      />
      <meta property="og:image:width" content={meta_data.openGraph.imageWidth} />
      <meta property="og:image:height" content={meta_data.openGraph.imageHeight} />
      ...
      <meta property="twitter:description" content={meta_data.twitter.description} />
